...
const colors = [
  ...
  "#a9784f", // tan
  "#6b4a2e", // dark brown
  "#4c584b", // graphite green
  "#9c7b52", // sand
  "#3f5346", // pine
];

const IMG = {
  disposable: "/placeholders/disposable.svg",
  pod: "/placeholders/pod.svg",
  liquid: "/placeholders/liquid.svg",
  salt: "/placeholders/salt.svg",
  cartridge: "/placeholders/cartridge.svg",
...
function seed() {
  ...
  const categories = [
    ["Одноразки", "disposable", 1],
    ["POD-системы", "pod", 2],
    ["Жидкости", "liquid", 3],
    ["Солевой никотин", "salt", 4],
    ["Картриджи", "cartridge", 5],
    ["Аксессуары", "accessory", 6],
  ];
  const catIds: number[] = [];
  ...
  const insertProduct = db.prepare(`
    INSERT INTO products
      (category_id, name, brand, description, price, old_price, stock, rating, reviews_count,
       nicotine, flavor, puffs, color, image, is_featured, is_new, is_active)
